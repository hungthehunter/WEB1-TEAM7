...
const mega_menu=document.getElementById("mega-menu");
 if(mega_menu.style.display==="none"){
...
const hardware_menu=document.getElementById("mobile-hardward");
if(hardware_menu.style.display==="none"){
    hardware_menu.style.display="block"
}else{
    hardware_menu.style.display="none"
}
}
function openSoftware(){
    const software_menu=document.getElementById("mobile-software");
    if(software_menu.style.display==="none"){
        software_menu.style.display="block"
    }else{
        software_menu.style.display="none"
    }
}
function openSolution(){
    const solution_menu=document.getElementById("mobile-solution");
    if(solution_menu.style.display==="none"){
        solution_menu.style.display="block"
    }else{
        solution_menu.style.display="none"
    }
}

function openIndustries(){
    const industries_menu=document.getElementById("mobile-industries");
    if(industries_menu.style.display==="none"){
        industries_menu.style.display="block"
    }else{
        industries_menu.style.display="none"
    }
}
function openForyou(){
    const foryou_menu=document.getElementById("mobile-foryou");
    if(foryou_menu.style.display==="none"){
        foryou_menu.style.display="block"
    }else{
        foryou_menu.style.display="none"
    }
}
function openCreatives_Designs(){
    const creatives_designs_menu=document.getElementById("mobile-creatives-designs");
    if(creatives_designs_menu.style.display==="none"){
        creatives_designs_menu.style.display="block"
    }else{
        creatives_designs_menu.style.display="none"
    }
}

function openData_Scientists(){
    const data_scientists_menu=document.getElementById("mobile-data-scientists");
    if(data_scientists_menu.style.display==="none"){
        data_scientists_menu.style.display="block"
    }else{
        data_scientists_menu.style.display="none"
    }
}

function openDevelopers(){
    const mobile_developer_menu=document.getElementById("mobile-developer");
    if(mobile_developer_menu.style.display==="none"){
        mobile_developer_menu.style.display="block"
    }else{
        mobile_developer_menu.style.display="none"
    }
}

function openGame(){
    const mobile_game_menu=document.getElementById("mobile-game");
    if(mobile_game_menu.style.display==="none"){
        mobile_game_menu.style.display="block"
    }else{
        mobile_game_menu.style.display="none"
    }
}
function openIT_Professionals(){
    const mobile_it_menu=document.getElementById("mobile-it");
    if(mobile_it_menu.style.display==="none"){
        mobile_it_menu.style.display="block"
    }else{
        mobile_it_menu.style.display="none"
    }
}
function openResearchers(){
    const mobile_researchers_menu=document.getElementById("mobile-researchers");
    if(mobile_researchers_menu.style.display==="none"){
        mobile_researchers_menu.style.display="block"
    }else{
        mobile_researchers_menu.style.display="none"
    }
}
function openRoboticists(){
    const mobile_roboticists_menu=document.getElementById("mobile-roboticists");
    if(mobile_roboticists_menu.style.display==="none"){
        mobile_roboticists_menu.style.display="block"
    }else{
        mobile_roboticists_menu.style.display="none"
